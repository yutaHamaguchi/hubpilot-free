...
| フェーズ              | 期間          | 主な作業内容                                               |
| --------------------- | ------------- | ---------------------------------------------------------- |
| 要件定義              | ～ 202X/XX    | 要件ヒアリング、要件定義書の策定                           |
| 設計・アーキテクチャ  | ～ 202X/XX    | Firebase 構成設計、HubSpot API 設計、カスタムプロパティ設計|
| 実装・単体テスト      | ～ 202X/XX    | Cloud Functions 実装、OAuth フロー実装、単体テスト         |
| 結合テスト・修正      | ～ 202X/XX    | HubSpot サンドボックスでテスト、エラー通知・ログ確認       |
| UAT・ドキュメント整備 | ～ 202X/XX    | ユーザ受け入れテスト、利用ガイド（簡易ドキュメント）作成   |
| 公開・運用開始        | 202X/XX ～    | HubSpot Marketplace で公開申請、リリース、運用・保守開始   |
